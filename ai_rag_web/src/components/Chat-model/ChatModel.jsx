...
const EmptyChatState = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full text-gray-500 rounded-lg empty-state">
        <div className='mb-8'>
        ...
        <div className={`transition-all duration-700 delay-700 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <button 
            ...
            className="bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg py-3 px-6 flex items-center justify-center transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1 active:translate-y-0 bounce-effect"
          >
...
return (
  <div className="flex flex-col h-screen bg-gray-50 chat-container">

    {/* Header */}
    <header className="bg-indigo-700 text-white p-3 shadow-md z-10 header-responsive">
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center">
          ...
          <div className="text-xl font-bold header-title">RAG Q&A Assistant</div>       
        </div>
        <div className="text-sm header-date">
    ...
    <div className="flex flex-1 overflow-hidden main-content">
      {/* Sidebar */}
      <aside className={`${sidebarOpen ? 'w-64' : 'w-0'} bg-gray-800 text-white transition-all duration-300 ease-in-out overflow-hidden flex flex-col sidebar-responsive ${!sidebarOpen ? 'sidebar-closed' : ''}`}>
      ...
      {/* Chat area */}
      <main className="flex-1 flex flex-col bg-white chat-area">
        {/* Messages */}
        <div className="flex-1 overflow-y-auto p-4 message-container">
          {currentChatId ? (
            <div className="max-w-3xl mx-auto space-y-6 messages-wrapper">
              {messages.map((message, index) => (
                ...
                >
                  ...
                  <div className={`rounded-lg px-4 py-3 message-bubble fade-in ${
                    message.sender === 'user' 
        ...
        {/* Input area */}
        <div className="border-t border-gray-200 bg-white p-4 input-container">
          <form onSubmit={handleSubmit} className="max-w-3xl mx-auto input-wrapper">
            <div className="flex items-center bg-gray-100 rounded-lg p-1 chat-input">
              <input
                type="text"
                value={query}
    ...
    {isPdfOverlayOpen && (
      <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 overlay">
        <div className="bg-white p-4 rounded-lg w-11/12 h-[550px] flex flex-col overlay-content">
      ...
      <div className="fixed inset-0 bg-black bg-opacity-30 z-50 flex justify-center items-center overlay">
        <div className="bg-white p-6 rounded-lg shadow-xl w-96 slide-in">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Link to="/login">
              <button
                className="px-4 py-2 bg-indigo-500 text-white rounded-md hover:bg-indigo-600 bounce-effect">
                Yes
              </button>
            </Link>
          </div>
